...
export class VerificationService {
  ...
  public register(login: string, pass: string, email: string, nickname: string): Observable<any>{
    const base = this.http.post(`http://localhost/tetris/api/register`,{
      username: login,
      pass: pass,
      email: email,
      nickname: nickname
  ...
  public login(login: string, pass: string ): Observable<any>{
    const base = this.http.post(`http://localhost/tetris/api/login`,{
      username: login,
      pass: pass
    })
  ...
  public updateUserDetails(): Observable<any>{
    const base = this.http.post(`http://localhost/tetris/api/refresh_token`,{
